...
class Entry(flask_db.Model):
    ...
    def html_content(self):
        ...
        # markup object tells flask that we trust the html content so it won't be escaped
...
def login():
    next_url = request.args.get('next') or request.form.get('next') # this isn't that great
...
def create():
    if request.method == 'POST':
        if request.form.get('title') and request.form.get('content'):
            entry = Entry.create(title=request.form['title'], content=request.form['content'],
